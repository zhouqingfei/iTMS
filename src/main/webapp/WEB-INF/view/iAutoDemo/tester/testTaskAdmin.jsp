	...
	<script> 
       		 ...
       		 <c:forEach var="testTask" items="${testTaskList}">　              
    		     ...
    		     "<td>"+"${testTask.result}"+"</td>"+
     		     "<td><div class='dropdown'>" + 
     		 		...
     		 		"<li role='presentation'><a role='menuitem' tabindex='-1' href='${pageContext.request.contextPath}/testTaskTester.do/edit?id=${testTask.id}'>编辑</a></li>"+
     		 		"<li role='presentation'><a role='menuitem' tabindex='-1' href='${pageContext.request.contextPath}/testTaskTester.do/execute?id=${testTask.id}'  onclick='return confirm('是否要执行该任务？')'>执行</a></li>"+				
		         		   ...
		         		   searchTaskList[i].process + "%</span></div></div></td>"+
		        		     ...
		        		     "<td>"+ searchTaskList[i].result + "</td>"+
		         		     "<td><div class='dropdown'>" + 
		         		 	    "<button type='button' class='btn dropdown-toggle' id='dropdownMenu1' data-toggle='dropdown'>操作<span class='caret'></span></button>" + 
		         		 	    "<ul class='dropdown-menu' role='menu' aria-labelledby='dropdownMenu1' style='min-width:100px;'>" +
		         		 		"<li role='presentation'><a role='menuitem' tabindex='-1' href='${pageContext.request.contextPath}/testTaskTester.do/edit?id=" + searchTaskList[i].id  + "'>编辑</a></li>"+
		         		 		"<li role='presentation'><a role='menuitem' tabindex='-1' href='${pageContext.request.contextPath}/testTaskTester.do/execute?id=" + searchTaskList[i].id + "'  onclick='return confirm('是否要执行该任务？')'>执行</a></li>"+				
        ...
        function delete_confirm(id,index) {
        	...
        	if (r==true)
    	    {
        	    ...
        	    var urlPath =  "${pageContext.request.contextPath}" + "/testTaskTester.do/delete?id=" +	testTaskId;		
    		        		...
    		        		for(var i=0;i < taskList.length;i++){
    		        		     ...
    		        		     "<td>"+ taskList[i].result + "</td>"+
    		         		     "<td><div class='dropdown'>" + 
    		         		 	    "<button type='button' class='btn dropdown-toggle' id='dropdownMenu1' data-toggle='dropdown'>操作<span class='caret'></span></button>" + 
    		         		 	    "<ul class='dropdown-menu' role='menu' aria-labelledby='dropdownMenu1' style='min-width:100px;'>" +
    		         		 		"<li role='presentation'><a role='menuitem' tabindex='-1' href='${pageContext.request.contextPath}/testTaskTester.do/edit?id=" + taskList[i].id  + "'>编辑</a></li>"+
    		         		 		"<li role='presentation'><a role='menuitem' tabindex='-1' href='${pageContext.request.contextPath}/testTaskTester.do/execute?id=" + taskList[i].id + "'  onclick='return confirm('是否要执行该任务？')'>执行</a></li>"+					
	...
	<div class="view-body">
		<div class="container" style="width: 95%;">
			...
			<div style="margin-top: 10px;">
				<a href="${pageContext.request.contextPath}/testTaskTester.do/add.view"
