...
<script type="text/javascript">
			    $(document).ready(function () {
			    	...
			    	-->
						...
						data = "<tr>"
							...
							+ "<li role='presentation'><a href='${pageContext.request.contextPath}/reportTester.do/downloadLog?logName=${testLog.logName}'>下载测试日志</a></li>"			
							+ "</ul></div></td></tr>";			
						allData.push(data);								
                    </c:forEach>
			    ...
			    function search(){
			    	    ...
			    	    var content=$("input[id=input]").val();
		         	    var urlPath =  "${pageContext.request.contextPath}" + "/reportTester.do/logSearch?content=" +	content;	
							...
							success: function(data){
								...
								for(var i=0; i< searchLogList.length; i++){
									var data = "<tr>"
										...
										+ "<li role='presentation'><a href='${pageContext.request.contextPath}/reportTester.do/downloadLog?logName=" + searchLogList[i].logName + "'>下载测试日志</a></li>"			
										+ "</ul></div></td></tr>";
									allData.push(data);
								}
								var Count = allData.length;//记录条数  
			        	...
			        	if (r==true)
				    	  {
			         	    ...
			         	    var urlPath =  "${pageContext.request.contextPath}" + "/reportTester.do/deleteLog?id=" + logId;		
								...
								success: function(data){
									...
									for(var i=0; i< logList.length; i++){
										...
										var data = "<tr>"
											...
											+ "<li role='presentation'><a href='${pageContext.request.contextPath}/reportTester.do/downloadLog?logName=" + tLog.logName + "'>下载测试日志</a></li>"			
											+ "</ul></div></td></tr>";
										allData.push(data);
									}
									var Count = allData.length;//记录条数  
									...
									<td>
										<div class="dropdown">
											...
											<ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1" style="min-width:100px;">
												...
												<li role="presentation">
												 <a href="${pageContext.request.contextPath}/reportTester.do/deleteLog?logId=${testLog.logId}"
	                                               onclick="return confirm('是否要删除该原生记录挡？')">删除</a>
													
												</li>
												<li role="presentation">
												<a 
											href="${pageContext.request.contextPath}/reportTester.do/openFileLog?logNumber=${testLog.logNumber}">打开测试日志</a>
										</li>
										<li role="presentation">
												<a 
											href="${pageContext.request.contextPath}/reportTester.do/downloadLog?logNumber=${testLog.logNumber}">下载测试日志</a>
										</li>
											</ul>
										</div>
									</td>
