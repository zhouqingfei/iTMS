...
<script type="text/javascript">
			    $(document).ready(function () {
					...
					<c:forEach var="testReport" items="${testReportlist}">
						...
						+ "删除</a></li>"	
						+ "<li role='presentation'>"
						+ "<a href='${pageContext.request.contextPath}/reportTester.do/downloadReport?reportName=${testReport.reportName}'>"
						+ "下载测试报告</a></li>"
						+ "</ul></div></td></tr>";
						allData.push(data);		
                    </c:forEach>
			    ...
			    function search(){
			    	    ...
			    	    var content=$("input[id=input]").val();
		         	    var urlPath =  "${pageContext.request.contextPath}" + "/reportTester.do/reportSearch?content=" +	content;		
							...
							success: function(data){
								...
								for(var i=0; i< searchReportList.length; i++){
									var data = "<tr>"
										...
										+ "删除</a></li>"	
										+ "<li role='presentation'>"
										+ "<a href='${pageContext.request.contextPath}/reportTester.do/downloadReport?reportName=" + searchReportList[i].reportName + "'>"
										+ "下载测试报告</a></li>"
										+ "</ul></div></td></tr>";
									allData.push(data);
								}
		        	...
		        	if (r==true)
			    	  {
		         	    ...
		         	    var urlPath =  "${pageContext.request.contextPath}" + "/reportTester.do/deleteReport?id=" + reportId;		
							...
							success: function(data){
								...
								for(var i=0; i< reportList.length; i++){
									...
									var data = "<tr>"
										...
										+ "删除</a></li>"	
										+ "<li role='presentation'>"
										+ "<a href='${pageContext.request.contextPath}/reportTester.do/downloadReport?reportName=" + report.reportName + "'>"
										+ "下载测试报告</a></li>"
										+ "</ul></div></td></tr>";
									allData.push(data);
								}
									...
									<td>
										<div class="dropdown">
											...
											<ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1" style="min-width:100px;">
												...
												<li role="presentation">
												 <a href="${pageContext.request.contextPath}/reportTester.do/deleteReport?reportId=${testReport.reportId}"
	                                               onclick="return confirm('是否要删除该测试报告？')">删除</a>
													
												</li>
												<li role="presentation">
												<a 
											href="${pageContext.request.contextPath}/reportTester.do/openFileReport?reportNumber=${testReport.reportNumber}">打开测试日志</a>
										</li>
										<li role="presentation">
												<a 
											href="${pageContext.request.contextPath}/reportTester.do/downloadReport?reportNumber=${testReport.reportNumber}">下载测试日志</a>
										</li>
