		...
		<div id="nav">
			...
			<ul>
				<li class="main" style="position:absolute;left:200px;top:0px;">
					...
					<a href="${pageContext.request.contextPath}/frontPageTester.do/frontPage.view">首页</a>     
				</li>
				...
				<li class="main" style="position:absolute;left:350px;top:0px;">
					...
					<a style="margin-left:-12px;" href="${pageContext.request.contextPath}/userAdminTester.do/userAdmin.view">用户管理</a>    
				</li>
				...
				<li class="main" style="position:absolute;left:500px;top:0px;">
					<img src="${pageContext.request.contextPath}/bower_components/iAutoDemo/images/machine.png" width="30"/><br/>
                        ...
                        <ul style="margin-left:-23px;">  
							<li><a href="${pageContext.request.contextPath}/machineTester.do/addMachine.view">新增机器(N.A.)</a></li>  
							<li><a href="${pageContext.request.contextPath}/machineTester.do/machineAdmin.view">机器管理(SUT/TEM)</a></li>	
							<li><a href="${pageContext.request.contextPath}/machineTester.do/preSetUp.view">线上预装</a></li>													
						</ul>   			
					</li>
				...
				<li class="main" style="position:absolute;left:650px;top:0px;">
					...
					<a style="margin-left:-29px;" href="${pageContext.request.contextPath}/testTaskTester.do/index.view">测试任务管理</a>         
				</li>
				...
				<li class="main" style="position:absolute;left:800px;top:0px;">
					...
					<ul>  
						<li><a href="${pageContext.request.contextPath}/reportTester.do/log.view">原生记录档</a></li>
					    <li><a href="${pageContext.request.contextPath}/reportTester.do/report.view">测试报告</a></li>
					</ul>  
				</li>
