		...
		<div class="container">
			<form class="form-inline" id="addNumberForm">	
				<table class="table table-striped table-bordered table-hover">
					<caption style="color: black; font-size: 23px; font-family: LiSu">修改密码</caption>
					<tr>
						<th width="480px">新密码</th>
						<td colspan="2">
							<div class="inputDivClass">
								<input class="inputClass" name="password" id="password" type=text value="" 
									placeholder="&nbsp请输入新密码......" /><label
			...
			<a href="javascript:;" class="btn btn-large btn-primary"
										...
										onclick="location ='${pageContext.request.contextPath}/userAdminDeveloper.do/updatePas?password='+document.getElementById('password').value;">修改密码</a>
