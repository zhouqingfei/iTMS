...
<%-- <script type="text/javascript"
	src="${pageContext.request.contextPath}/bower_components/iAutoDemo/js/editMachineInfo.js"></script>
	 --%>
	<style>        
        .table {
            border: 2px;
		...
		function save() {
			...
			if(bool){
		    	...
		    	if (r==true)
			    {
		    	    ...
		    	    var urlPath =  "${pageContext.request.contextPath}" + "/machineDeveloper.do/machineUpdate";
					var machine = {
							"model":model,
							"type":type,
							"host_mac":host_mac,
...
<body>
    ...
    <div class="view-body" style="min-width:1480px;">
        <div class="container" style="width: 80%;float:left; margin-top: 30px;margin-left: 50px;">
            <table class="table table-striped table-bordered table-hover">
                <caption style="color: black; font-size: 23px; font-family: LiSu">编辑机器信息</caption>
                <tr>
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <div class="inputDivClass">
                            <input class="inputClass" name="model" id="model" type=text value="${machineInfo.model}" placeholder="&nbsp请输入机器型号......" /> <label class="errorClass" id="modelError"></label>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <div class="inputDivClass">
                            <input class="inputClass"  disabled name="hostMacAddr" id="hostMacAddr" type=text value="${machineInfo.host_mac}" placeholder="&nbsp请输入主机网络实体地址......" /> <label class="errorClass" id="hostMacAddrError"></label>
                        </div>
                    </td>
                </tr>
				 ...
				 <tr>
                    ...
                    <td colspan="2">
                        <div class="inputDivClass">
                            <input class="inputClass" name="bmcId" id="bmcId" type=text value="${machineInfo.bmc_user}" placeholder="&nbsp请输入BMC账号......" /> <label class="errorClass" id="bmcIdError"></label>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <div class="inputDivClass">
                            <input class="inputClass" name="bmcPwd" id="bmcPwd" type=text value="${machineInfo.bmc_psd}" placeholder="&nbsp请输入BMC密码......" /> <label class="errorClass" id="bmcPwdError"></label>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <div class="inputDivClass">
                            <input class="inputClass" name="bmcMacAddr" id="bmcMacAddr" type=text value="${machineInfo.bmc_mac}" placeholder="&nbsp请输入BMC网络实体地址......" /> <label class="errorClass" id="bmcMacAddrError"></label>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <div class="inputDivClass">
                            <input class="inputClass" name="user" id="user" type=text value="${machineInfo.user}" placeholder="&nbsp使用者账号......" /> <label class="errorClass" id="userError"></label>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <div class="inputDivClass">
                            <input class="inputClass" name="comment" id="comment" type=text value="${machineInfo.comment}" placeholder="&nbsp请输入备注......" /> <label class="errorClass" id="commentError"></label>
                        </div>
                    </td>
                </tr>
        ...
        <a href="${pageContext.request.contextPath}/machineDeveloper.do/machineAdmin.view" id="backBth" class="btn btn-large btn-primary" style="position: absolute; right: 20px; top: 220px;">返回前页</a>
    </div>
</body>
</html>