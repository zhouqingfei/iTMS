...
<html>
	<head>
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/bower_components/iAutoDemo/js/editTestSuitDeveloper.js"></script>
			...
			<div class="container">
				<form class="form-inline" id="editTestSuitForm">
					...
					style="position: absolute; right: 20px; top: 170px;"> </input>
                     <a href="${pageContext.request.contextPath}/testSuitDeveloper.do/index.view" class="btn btn-large btn-primary" style="position:absolute;right:20px;top:220px;">返回前页</a>                   
				</form>
