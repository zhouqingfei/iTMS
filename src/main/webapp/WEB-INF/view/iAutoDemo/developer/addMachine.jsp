...
<title>新增机器</title>
	...
	<script>
		...
		function scan(){
	    	...
	    	var urlPath =  "${pageContext.request.contextPath}" + "/machineDeveloper.do/scan?id=" + id;
	    	//alert(urlPath);
	    	showLoading();
	        		...
	        		for(var i=0;i < machineList.length;i++){
	        			var tr="<tr>"+  
		     		     ...
		     		     "<td><div class='dropdown'>" + 
		     		 		...
		     		 		"<li role='presentation'><a href='${pageContext.request.contextPath}/machineDeveloper.do/createMachineInfo?id=" + (i+1) + "'>新建机器信息</a></li></ul>"+			
		     		 	"</div></td></tr>";  
	        			if((i+1)%2==1){
