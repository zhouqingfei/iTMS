...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/bower_components/iAutoDemo/js/editTestTaskDeveloper.js"></script>
<style>
.container {
	width: 90%;
	margin-left: 100px;
					...
					<tr id="tcList">
						...
						<td colspan="3">
							<table style="width: 100%;" id="testCaseListTable"
								...
								<div class="sideBut">
									<a href="${pageContext.request.contextPath}/testTaskDeveloper.do/index.view"
										class="btn btn-large btn-primary"
