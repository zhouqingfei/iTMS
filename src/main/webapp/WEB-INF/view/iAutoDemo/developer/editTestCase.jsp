...
<script type="text/javascript"
	...
	<script type="text/javascript"
	src="${pageContext.request.contextPath}/bower_components/iAutoDemo/js/editTestCaseDeveloper.js"></script>
...
<body>
	...
	<div class="view-body">
		<div class="container">
			...
			<a href="${pageContext.request.contextPath}/testCaseDeveloper.do/index.view"
