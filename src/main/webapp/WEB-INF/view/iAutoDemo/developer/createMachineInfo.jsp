		...
		function save() {
			...
			if(bool)
			{
		    	...
		    	if (r==true)
			    {
		    	    ...
		    	    var urlPath =  "${pageContext.request.contextPath}" + "/machineDeveloper.do/save";
...
<body>
    ...
    <div class="view-body" style="min-width:1480px;">
        ...
        <a href="${pageContext.request.contextPath}/machineDeveloper.do/addMachine.view" id="backBth" class="btn btn-large btn-primary" style="position: absolute; right: 20px; top: 220px;">返回前页</a>
    </div>
</body>
</html>