		 ...
		 $(function(){
			 ...
			 <c:forEach var="testTask" items="${testTaskList}">　              
	 		     ...
	 		     "<td><div class='dropdown'>" + 
	 		 		...
	 		 		"<li role='presentation'><a role='menuitem' tabindex='-1' href='${pageContext.request.contextPath}/reportDeveloper.do/downloadRecentReport?reportNumber=${testTask.id}'>下载</a></li>"+
	 		 	"</div></td></tr>";  
	 		     allData.push(data);
			 </c:forEach>
   		        		...
   		        		for(var i=0;i < searchTaskList.length;i++){
		         		   ...
		         		   searchTaskList[i].process + "%</span></div></div></td>"+
		        		     ...
		        		     "<td><div class='dropdown'>" + 
		 	 		 	    "<button type='button' class='btn dropdown-toggle' id='dropdownMenu1' data-toggle='dropdown'>操作<span class='caret'></span></button>" + 
		 	 		 	    "<ul class='dropdown-menu' role='menu' aria-labelledby='dropdownMenu1' style='min-width:100px;'>" +
		 	 		 		"<li role='presentation'><a role='menuitem' tabindex='-1' href='${pageContext.request.contextPath}/reportDeveloper.do/downloadRecentReport?reportNumber="+searchTaskList[i].id+"'>下载</a></li>"+
		 	 		 	"</div></td></tr>"; 
   			     		     allData.push(data);
   		        		}
