...
<script type="text/javascript">
			    $(document).ready(function () {
			    	...
			    	-->
						...
						data = "<tr>"
							...
							+ "<li role='presentation'><a href='${pageContext.request.contextPath}/report.do/downloadLog?logName=${testLog.logName}'>下载测试日志</a></li>"			
							+ "</ul></div></td></tr>";			
						allData.push(data);								
                    </c:forEach>
			    ...
			    function search(){
			    	    ...
			    	    var content=$("input[id=input]").val();
		         	    var urlPath =  "${pageContext.request.contextPath}" + "/report.do/logSearch?content=" +	content;	
							...
							success: function(data){
								...
								for(var i=0; i< searchLogList.length; i++){
									var data = "<tr>"
										...
										+ "<li role='presentation'><a href='${pageContext.request.contextPath}/report.do/downloadLog?logName=" + searchLogList[i].logName + "'>下载测试日志</a></li>"			
										+ "</ul></div></td></tr>";
									allData.push(data);
								}
								var Count = allData.length;//记录条数  
			        	...
			        	if (r==true)
				    	  {
			         	    ...
			         	    var urlPath =  "${pageContext.request.contextPath}" + "/report.do/deleteLog?id=" + logId;		
								...
								success: function(data){
									...
									for(var i=0; i< logList.length; i++){
										...
										var data = "<tr>"
											...
											+ "<li role='presentation'><a href='${pageContext.request.contextPath}/report.do/downloadLog?logName=" + tLog.logName + "'>下载测试日志</a></li>"			
											+ "</ul></div></td></tr>";
										allData.push(data);
									}
									var Count = allData.length;//记录条数  
