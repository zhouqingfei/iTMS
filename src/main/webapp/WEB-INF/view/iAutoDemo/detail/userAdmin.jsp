...
<body>
	...
	<div class="view-body">
		<div class="container">
			...
			<a href="${pageContext.request.contextPath}/userAdmin.do/updatePassword"
			...
			<a href="${pageContext.request.contextPath}/userAdmin.do/addNumber.view"
				class="btn btn-large btn-primary"
										...
										<div class="dropdown">
											...
											<ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1" style="min-width:100px;">
												<li role="presentation">
													<a role="menuitem" tabindex="-1" target=“_blank” href="${pageContext.request.contextPath}/userAdmin.do/openUser?userId=${user.userId}">打开</a>
												</li>
												<li role="presentation">
												 <a href="${pageContext.request.contextPath}/user.do/deleteNumber?userId=${user.userId}"
