...
<head>
		...
		<script> 
	        	...
	        	/* $("button[id=button]").click(function(){
        		 ...
        		 <c:forEach var="testCase" items="${testCaseList}">　              
	     		     ...
	     		     "<td><div class='dropdown'>" + 
	     		 		...
	     		 		"<li role='presentation'><a role='menuitem' tabindex='-1' href='${pageContext.request.contextPath}/testCaseLeader.do/edit?id=${testCase.id}'>编辑</a></li>"+
	       ...
	       function search(){
       	    ...
       	    /* alert(content); */
       	    var urlPath =  "${pageContext.request.contextPath}" + "/testCaseLeader.do/testCaseSearch?content=" +	content;		
   		        		...
   		        		for(var i=0;i < searchCaseList.length;i++){
   		        			var data="<tr>"+  
   			     		     ...
   			     		     "<td><div class='dropdown'>" + 
   			     		 	    "<button type='button' class='btn dropdown-toggle' id='dropdownMenu1' data-toggle='dropdown'>操作<span class='caret'></span></button>" + 
   			     		 	    "<ul class='dropdown-menu' role='menu' aria-labelledby='dropdownMenu1' style='min-width:100px;'>" +
   			     		 		"<li role='presentation'><a role='menuitem' tabindex='-1' href='${pageContext.request.contextPath}/testCaseLeader.do/edit?id=" + searchCaseList[i].id +"'>编辑</a></li>"+
	        ...
	        function delete_confirm(id,index) {
	        	...
	        	if (r==true)
        	    {
	        	    ...
	        	    var urlPath =  "${pageContext.request.contextPath}" + "/testCaseLeader.do/delete?id=" +	testCaseId;		
	    		        		...
	    		        		for(var i=0;i < caseList.length;i++){
	    		        			var data="<tr>"+  
	    			     		     ...
	    			     		     "<td><div class='dropdown'>" + 
	    			     		 	    "<button type='button' class='btn dropdown-toggle' id='dropdownMenu1' data-toggle='dropdown'>操作<span class='caret'></span></button>" + 
	    			     		 	    "<ul class='dropdown-menu' role='menu' aria-labelledby='dropdownMenu1' style='min-width:100px;'>" +
	    			     		 		"<li role='presentation'><a role='menuitem' tabindex='-1' href='${pageContext.request.contextPath}/testCaseLeader.do/edit?id="+ caseList[i].id +"'>编辑</a></li>"+
		...
		<div class="view-body">
			<div class="container" style="width:96%;">
				...
				<div style="margin-top:10px;">
					 <a href="${pageContext.request.contextPath}/testCaseLeader.do/add.view" class="btn btn-large btn-primary" style="float:right;margin-top:20px;">+新建用例</a>  
