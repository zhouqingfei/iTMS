...
<title>设备管理</title>
	...
	<script>
		...
		function update(){
	    	...
	    	var urlPath =  "${pageContext.request.contextPath}" + "/machineLeader.do/update?id=" + id;
	    	showLoading();
		...
		function editMachineInfo(a) {
	    	...
	    	var urlPath = "${pageContext.request.contextPath}" + "/machineLeader.do/updateMachineInfo?id=" + id + "&hostMac=" + hostMac;
	    	var desPath = "${pageContext.request.contextPath}" + "/machineLeader.do/updateMachineInfo?id=" + id + "&hostMac=" + hostMac;
	    	$.ajax({  
		        data:"",  
		        type:"GET",
		        contentType :'application/json; charset=utf-8',
		...
		/*  function preSetUp(a) {
			    var hostMac = $(a).parent().parent().parent().parent().prev().prev().prev().prev().prev().prev().prev().text();
			    var id = $(a).parent().parent().parent().parent().parent().children(":first-child").text();
 	    	//var urlPath = "${pageContext.request.contextPath}" + "/machineLeader.do/preSetUp?hostMac=" + hostMac;
 	    	var urlPath = "${pageContext.request.contextPath}" + "/machineLeader.do/preSetUp?id=" + id + "&hostMac=" + hostMac;
 	    	$.ajax({  
 		        data:"",  
 		        type:"GET",
 		        contentType :'application/json; charset=utf-8',
		 ...
		 function statusUpdate(a) {
				 showLoading();
			    var hostMac = $(a).parent().parent().parent().parent().prev().prev().prev().prev().prev().prev().prev().text();
	            var urlPath = "${pageContext.request.contextPath}" + "/machineLeader.do/statusUpdate?hostMac=" + hostMac;
	            console.log("test");
		 ...
		 function deleteMachine(a) {
			  var r=confirm("确定要删除机器？")
	        	if (r==true){
	        		var hostMac = $(a).parent().parent().parent().parent().prev().prev().prev().prev().prev().prev().prev().text();
		            var urlPath = "${pageContext.request.contextPath}" + "/machineLeader.do/deleteMachine?hostMac=" + hostMac;
		 	    	$.ajax({  
		 		        data:"",  
		 		        type:"GET",
		 		        contentType :'application/json; charset=utf-8',
		 ...
		 function powerOn(a) {
			  var r=confirm("确定要执行开机操作？")
	        	if (r==true){
	        		var hostMac = $(a).parent().parent().parent().parent().prev().prev().prev().prev().prev().prev().prev().text();
		            var urlPath = "${pageContext.request.contextPath}" + "/machineLeader.do/powerOn?hostMac=" + hostMac;
		            showLoading();
		 	    	$.ajax({  
		 		        data:"",  
		 		        type:"GET",
		 ...
		 function powerOff(a) { 
			 var r=confirm("确定要执行关机操作？")
	        	if (r==true){
			    var hostMac = $(a).parent().parent().parent().parent().prev().prev().prev().prev().prev().prev().prev().text();
	            var urlPath = "${pageContext.request.contextPath}" + "/machineLeader.do/powerOff?hostMac=" + hostMac;
	            showLoading();
	 	    	$.ajax({  
	 		        data:"",  
	 		        type:"GET",
		 ...
		 function installAEP(a) {
			  var r=confirm("确定要部署AEP？")
	        	if (r==true){
	        		var hostMac = $(a).parent().parent().parent().parent().prev().prev().prev().prev().prev().prev().prev().text();
		            var urlPath = "${pageContext.request.contextPath}" + "/machineLeader.do/installAEP?hostMac=" + hostMac;
		            showLoading();
		 	    	$.ajax({  
		 		        data:"",  
		 		        type:"GET",
