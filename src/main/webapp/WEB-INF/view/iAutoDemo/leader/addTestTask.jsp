...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/bower_components/iAutoDemo/js/addTestTaskLeader.js"></script>
<style>
	.container{
			width:90%;
			margin-left:100px;
			...
			<form class="form-inline" id="addTestTaskForm">
				...
				<div class="sideBut">
					<a href ="javascript:;" class="btn btn-large btn-primary"
						...
						onclick="location ='${pageContext.request.contextPath}/testTaskLeader.do/execute?id='+document.getElementById('id').value;">执行任务</a>
					<a href="${pageContext.request.contextPath}/testTaskLeader.do/index.view" class="btn btn-large btn-primary"
