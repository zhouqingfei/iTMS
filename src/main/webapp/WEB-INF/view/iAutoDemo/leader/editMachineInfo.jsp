		...
		function save() {
			...
			if(bool){
		    	...
		    	if (r==true)
			    {
		    	    ...
		    	    var urlPath =  "${pageContext.request.contextPath}" + "/machineLeader.do/machineUpdate";
					var machine = {
							"model":model,
							"type":type,
							"host_mac":host_mac,
...
<body>
    ...
    <div class="view-body" style="min-width:1480px;">
        ...
        <a href="${pageContext.request.contextPath}/machineLeader.do/machineAdmin.view" id="backBth" class="btn btn-large btn-primary" style="position: absolute; right: 20px; top: 220px;">返回前页</a>
    </div>
</body>
</html>