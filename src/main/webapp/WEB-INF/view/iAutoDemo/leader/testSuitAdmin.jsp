		...
		<script> 
	        $(function(){
	       		 ...
	       		 <c:forEach var="testSuit" items="${testSuitList}">　              
	     		     ...
	     		     "<td><div class='dropdown'>"+
	     		 	    "<button type='button' class='btn dropdown-toggle' id='dropdownMenu1' data-toggle='dropdown'>操作<span class='caret'></span></button>" + 
	     		 			...
	     		 			"<li role='presentation'><a role='menuitem' tabindex='-1' href='${pageContext.request.contextPath}/testSuitLeader.do/edit?id=${testSuit.id}'>编辑</a></li>"+
		       ...
		       function search(){
		       	    ...
		       	    /* alert(content); */
		       	    var urlPath =  "${pageContext.request.contextPath}" + "/testSuitLeader.do/testSuitSearch?content=" +	content;		
		   			 ...
		   			 $.ajax({  
		   			        ...
		   			        success:function(data){
    		         		     ...
    		         		     "<td><div class='dropdown'>" + 
    		         		 	    "<button type='button' class='btn dropdown-toggle' id='dropdownMenu1' data-toggle='dropdown'>操作<span class='caret'></span></button>" + 
    		         		 	    "<ul class='dropdown-menu' role='menu' aria-labelledby='dropdownMenu1' style='min-width:100px;'>" +
    		         		 	  		"<li role='presentation'><a role='menuitem' tabindex='-1' href='${pageContext.request.contextPath}/testSuitLeader.do/edit?id=" + searchSuitList[i].id + "'>编辑</a></li>"+
	        ...
	        function delete_confirm(id,index) {
	        	...
	        	if (r==true)
	    	    {
	        	    ...
	        	    var urlPath =  "${pageContext.request.contextPath}" + "/testSuitLeader.do/delete?id=" +	testSuitId;		
	    		        		...
	    		        		for(var i=0;i < suitList.length;i++){
	    		        		     var data="<tr>"+  
	    		         		     ...
	    		         		     "<td><div class='dropdown'>" + 
	    		         		 	    "<button type='button' class='btn dropdown-toggle' id='dropdownMenu1' data-toggle='dropdown'>操作<span class='caret'></span></button>" + 
	    		         		 	    "<ul class='dropdown-menu' role='menu' aria-labelledby='dropdownMenu1' style='min-width:100px;'>" +
	    		         		 	  		"<li role='presentation'><a role='menuitem' tabindex='-1' href='${pageContext.request.contextPath}/testSuitLeader.do/edit?id=" + suitList[i].id + "'>编辑</a></li>"+
		...
		<div class="view-body">
			<div class="container" style="width:95%;">
				...
				<div style="margin-top:20px;">
					<a  href="${pageContext.request.contextPath}/testSuitLeader.do/add.view" class="btn btn-large btn-primary" style="float:right;margin-top:20px;">+新建套件</a>  
