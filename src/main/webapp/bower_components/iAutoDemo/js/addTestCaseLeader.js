$(function() {
	 ...
	 * 5. 表单提交时进行校验
	 */
	$("#addTestCaseForm").submit(function() {
		//alert("nimei");
		...
		if(bool){
			...
			var urlPath = document.getElementById("path").value+"/testCaseLeader.do/add";
	        var desPath = document.getElementById("path").value+"/testCaseLeader.do/index.view";
			var testcase = {
					"id":id,
