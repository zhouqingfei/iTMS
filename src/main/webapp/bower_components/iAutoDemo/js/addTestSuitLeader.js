$(function() {
	 ...
	 * 5. 表单提交时进行校验
	 */
	$("#addTestSuitForm").submit(function() {
		...
		if(bool){//提交数据
			...
			var urlPath = document.getElementById("path").value+"/testSuitLeader.do/add";
			var desPath = document.getElementById("path").value+"/testSuitLeader.do/index.view";
			var testsuit = {
				"id":id,
