$(function() {
	 ...
	 * 4. 表单提交时进行校验
	 */
	$("#addTestTaskForm").submit(function() {
		...
		if(bool){//提交数据
			...
			//alert(sutInfo);
			var urlPath = document.getElementById("path").value+"/testTaskDeveloper.do/add";
...
function insertTr(index){
	...
	td3.innerHTML="<td><a  onclick='showFirstDescribe()'>说明</a> <a onclick='deleteRow(this)'>删除</a> <a onclick='addTestCase(this)'>插入</a></td>";
