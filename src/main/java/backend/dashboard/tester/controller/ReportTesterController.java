...
@Controller
@RequestMapping("reportTester.do")
public class ReportTesterController {
	...
	public String logView(Model model, HttpSession session) {
		...
		return "/iAutoDemo/tester/testLogAdmin";
	...
	public String reportView(Model model, HttpSession session) {
		...
		return "/iAutoDemo/tester/testReportAdmin";
		// return "/admin/system/user/user_add";
	}
	@RequiresRoles("tester")
	...
	public String openFileLog(String logNumber) {
		try {
			Desktop.getDesktop()
					.open(new File(new File(testTaskDir, "testTask"), "testTask_" + logNumber + "_log.zip"));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		return "redirect:/reportTester.do/log.view";
	}
	...
	public String openFileReport(String reportNumber) {
		try {
			Desktop.getDesktop()
					.open(new File(new File(testTaskDir, "testTask"), "testTask_" + reportNumber + "_report.pdf"));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		return "redirect:/reportTester.do/report.view";
	}
	...
	public String openFileReportFrontPage(String reportNumber) {
		...
		return "redirect:/frontPageTester.do/frontPage.view";
	}
