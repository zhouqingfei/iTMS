...
@Controller
@RequestMapping("testTaskTester.do")
public class TestTaskTesterController {
	...
	public String index(Model model, HttpSession session) {
		...
		return "/iAutoDemo/tester/testTaskAdmin";
	}
	...
	public String addView(Model model, HttpSession session) {
		...
		return "/iAutoDemo/tester/addTestTask";
	}
	...
	public String edit(int id, Model model, HttpSession session) {
		...
		return "/iAutoDemo/tester/editTestTask";
	}
	...
	public String openFile(String reportNumber) {
		...
		return "redirect:/testTaskTester.do/index.view";
	}
