...
@Controller
@RequestMapping("testSuitDeveloper.do")
public class TestSuitDeveloperController {
    ...
    private TestCaseBiz testCaseBiz;
	 @RequiresRoles("developer")
	    ...
	    public String index(Model model) {
		 model.addAttribute("testSuitList", testSuitBiz.findAll());
	        return "/iAutoDemo/developer/testSuitAdmin";
	    }
	 ...
	 @RequiresRoles("developer")
	    ...
	    public String addView(Model model) {
		 model.addAttribute("testCaseList", testCaseBiz.findAll());
	        return "/iAutoDemo/developer/addTestSuit";
	 ...
	 @RequiresRoles("developer")
	    ...
	    public String edit(int id,Model model) {
		 ...
		 return "/iAutoDemo/developer/editTestSuit";
	    }
