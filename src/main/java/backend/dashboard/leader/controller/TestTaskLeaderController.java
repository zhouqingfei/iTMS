...
@Controller
@RequestMapping("testTaskLeader.do")
public class TestTaskLeaderController {
	...
	public String index(Model model, HttpSession session) {
		...
		return "/iAutoDemo/leader/testTaskAdmin";
	}
	...
	public String addView(Model model, HttpSession session) {
		...
		return "/iAutoDemo/leader/addTestTask";
	}
	...
	public String openFile(String reportNumber) {
		...
		return "redirect:/testTaskLeader.do/index.view";
	}
