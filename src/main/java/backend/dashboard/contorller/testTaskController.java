...
public class testTaskController {
	...
	public String index(Model model, HttpSession session) {
		...
		return "/iAutoDemo/detail/testTaskAdmin";
	}
	...
	public String addView(Model model, HttpSession session) {
		...
		return "/iAutoDemo/detail/addTestTask";
	}
	...
	public String edit(int id, Model model, HttpSession session) {
		...
		return "/iAutoDemo/detail/editTestTask";
	}
	...
	public String openFile(String reportNumber) {
		try {
			...
			//Desktop.getDesktop().open(new File("/home/acp/testTask_" + reportNumber + "_report.pdf"));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		return "redirect:/testTask.do/index.view";
	}
